(function() {
  ...
  Subsonic.on('cover', function(newCover) {
    newCover = newCover ? newCover  + '&size=48' : 'assets/images/icon.png';
    chrome.browserAction.setIcon({
      path: newCover
    });
  });

  Subsonic.on('title', function(newTitle) {
    var newArtist = Subsonic.artist() || 'Subsonic++';
    newTitle = newTitle || 'No music played';
